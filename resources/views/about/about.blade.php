...
<main id="main" class="main" itemscope="" itemtype="https://schema.org/Blog" style="height: auto !important;">
    ...
    <img src="{{ secure_asset('images/LINE_ALBUM_240221_11.jpg/') }}" class="img_page"><br><br>
    
    <p>チーム創立は2014年、チームリーダーとその自転車仲間数名から始まった当チームは、</p>
    <p>少しずつ仲間の輪を広げながら現在では10〜30代のメンバーを中心に20名以上で活動しています。</p>
    <img style="margin: 30px 0px 0px 0px;" src="{{ secure_asset('images/LINE_ALBUM_240221_0.jpg/') }}" class="img_page"><br>
    ...
    <img src="{{ secure_asset('images/LINE_ALBUM_240222_33.jpg/') }}" class="img_page"><br>
    
    <p>定期的に練習会は行っていますが、参加の強制や活動ノルマは一切なし。</p>
    <p>近年では県内や近隣のレースで入賞・優勝の機会も増えてきましたが、あくまでメンバー各々の努力の成果です。<br>ほんとに。</p>
    <img src="{{ secure_asset('images/V2Yo1po68cCM4KY1720440438_1720440489.jpg/') }}" class="img_page"><br>
    ...
    <img src="{{ secure_asset('images/kblDtCmTZFV5y061720440273_1720440321.jpg/') }}" class="img_page">
</main>
@endsection